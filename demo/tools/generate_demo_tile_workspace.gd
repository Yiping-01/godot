...
const COLUMNS := 8
const ROWS := 4
const TILE_DIR := "res://demo/assets/tiles"
const TILE_IMAGE_PATH := "res://demo/assets/tiles/demo_floor_tilesheet.png"
const TILESET_PATH := "res://demo/assets/tiles/demo_floor_tileset.tres"
