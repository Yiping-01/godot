...
var texts := {
	"zh": {
		...
		"DEMO_TITLE": "妳看起來很好吃",
		"DEMO_SUBTITLE": "潛入海溝，沿著潮流回收失落的痕跡。",
		"DEMO_START": "開始",
		"DEMO_CONTINUE": "繼續",
		"DEMO_QUIT": "離開",
		"DEMO_PAUSED": "暫停",
		...
		"DEMO_SFX": "音效：%d%%",
		"DEMO_LANGUAGE": "語言",
		"DEMO_KEY_SETTINGS": "按鍵設定",
		"DEMO_RESET": "重設",
		"DEMO_BACK": "返回",
		"DEMO_CANCELLED": "已取消。",
		"DEMO_KEY_CHANGED": "按鍵已更新。",
		"DEMO_KEY_FAILED": "這個按鍵無法使用。",
		"AUDIO_TITLE": "音量設定",
		"AUDIO_MUSIC": "背景音樂：%d%%",
		"AUDIO_SFX": "音效：%d%%",
		...
		"INV_HINT": "Tab：切換頁面 / 方向鍵：選擇 / Enter 或 {interact}：裝備 / {inventory} 或 Esc：關閉",
		...
		"SHOP_TITLE": "%s 的商店",
		"SHOP_HINT": "方向鍵選擇 / {interact} 購買 / {inventory} 或 Esc：關閉",
		...
		"ITEM_LIFE_FRAGMENT_DESC": "凝聚海溝生命力的碎片，仍帶著微弱暖意。",
		"ITEM_OLD_MAP": "破舊地圖",
		"ITEM_OLD_MAP_DESC": "標記附近通道與房間配置。",
	...
	"en": {
		...
		"DEMO_TITLE": "妳看起來很好吃",
		"DEMO_SUBTITLE": "Dive into the trench and follow the current through what was left behind.",
		"DEMO_START": "Start",
		...
		"DEMO_MAIN_MENU": "Main Menu",
		"DEMO_MUSIC": "Music: %d%%",
		"DEMO_SFX": "SFX: %d%%",
		"DEMO_LANGUAGE": "Language",
		"DEMO_KEY_SETTINGS": "Key Settings",
		"DEMO_RESET": "Reset",
		"DEMO_BACK": "Back",
		"DEMO_CANCELLED": "Cancelled.",
		"DEMO_KEY_CHANGED": "Key changed.",
		"DEMO_KEY_FAILED": "This key cannot be used.",
		...
		"INV_HINT": "Tab: Switch page / Arrow keys: Select / Enter or {interact}: Equip / {inventory} or Esc: Close",
		...
		"SHOP_TITLE": "%s's Shop",
		"SHOP_HINT": "Arrow keys: Select / {interact}: Buy / {inventory} or Esc: Close",
		...
		"ITEM_ROUGH_CHARM_DESC": "A small charm pieced together from recycled parts.",
		"ITEM_LIFE_FRAGMENT": "Life Fragment",
		"ITEM_LIFE_FRAGMENT_DESC": "A fragment carrying the faint warmth of life from the trench.",
		"ITEM_OLD_MAP": "Old Map",
		"ITEM_OLD_MAP_DESC": "Marks nearby passages and room layouts.",
...
var raw_texts := {
	...
	"你可以用金錢購買測試物品。": "Trade recycled bottles for supplies.",
	"按 I 可以打開背包查看。": "Press {inventory} to open your inventory.",
	"打倒敵人取得金錢後，可以回來買一些暫時道具。": "Bring back bottles from the trench and trade them for supplies.",
	"尚未寫入說明。": "Its surface still bears the marks of the current.",
	...
	"暫時用的護符道具，會放入背包。": "A small charm pieced together from recycled parts.",
	"暫時用的生命道具，之後可接最大血量。": "A fragment carrying the faint warmth of life from the trench.",
...
func _clean_text_override(key: String) -> String:
	...
	var zh := {
		...
		"SHOP_TITLE": "%s 的回收補給站",
		"SHOP_HINT": "方向鍵選擇 / E 購買 / I 或 Esc：關閉",
