...
func start_phase() -> void:
	...
	DEMO_COMBAT_JUICE.shake_camera(self, 1.1, 16.0)
	_reveal_octopus()
...
func _on_tentacle_defeated(_tentacle: Node) -> void:
	alive_tentacles -= 1
	DEMO_COMBAT_JUICE.shake_camera(self, 0.26, 6.5)
...
func _show_core() -> void:
	...
	DEMO_COMBAT_JUICE.shake_camera(self, 0.55, 10.0)
...
func _on_core_defeated() -> void:
	...
	DEMO_COMBAT_JUICE.shake_camera(self, 0.8, 12.0)
	phase_finished.emit()
