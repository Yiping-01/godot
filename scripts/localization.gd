...
var texts := {
	"zh": {
		...
		"HULOB_TITLE": "妳看起來很好吃",
		"HULOB_SUBTITLE": "可編輯的新流程：UI、地圖、游泳與 Boss 測試。",
		"HULOB_START": "開始",
		"HULOB_CONTINUE": "繼續",
		"HULOB_QUIT": "離開",
		"HULOB_PAUSED": "暫停",
		...
		"HULOB_SFX": "音效：%d%%",
		"HULOB_LANGUAGE": "語言",
		"HULOB_KEY_SETTINGS": "按鍵設定",
		"HULOB_RESET": "重設",
		"HULOB_BACK": "返回",
		"HULOB_CANCELLED": "已取消。",
		"HULOB_KEY_CHANGED": "按鍵已更新。",
		"HULOB_KEY_FAILED": "這個按鍵無法使用。",
		"AUDIO_TITLE": "音量設定",
		"AUDIO_MUSIC": "背景音樂：%d%%",
		"AUDIO_SFX": "音效：%d%%",
	...
	"en": {
		...
		"HULOB_TITLE": "妳看起來很好吃",
		"HULOB_SUBTITLE": "Editable route for UI, map, swimming and boss tests.",
		"HULOB_START": "Start",
		"HULOB_CONTINUE": "Continue",
		"HULOB_QUIT": "Quit",
		"HULOB_PAUSED": "PAUSED",
		"HULOB_RESUME": "Resume",
		"HULOB_SETTINGS": "Settings",
		"HULOB_MAIN_MENU": "Main Menu",
		"HULOB_MUSIC": "Music: %d%%",
		"HULOB_SFX": "SFX: %d%%",
		"HULOB_LANGUAGE": "Language",
		"HULOB_KEY_SETTINGS": "Key Settings",
		"HULOB_RESET": "Reset",
		"HULOB_BACK": "Back",
		"HULOB_CANCELLED": "Cancelled.",
		"HULOB_KEY_CHANGED": "Key changed.",
		"HULOB_KEY_FAILED": "This key cannot be used.",
