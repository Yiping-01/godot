...
const HUD_EMBLEM_PATH := "res://hulobOuO/assets/hud/new_healthbar.png"
const SKILL_FALLBACK_TEXTURE := preload("res://assets/player/attack_far/far_1.png")
