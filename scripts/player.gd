...
const WATER_EXIT_PARTICLE_TEXTURE := preload("res://hulobOuO/assets/hollow_import/effects/water_footstep_particle.png")
const AIR_JUMP_PARTICLE_TEXTURE := preload("res://hulobOuO/assets/hollow_import/effects/white_hit_particle.png")
...
func _try_ultimate_attack() -> void:
	...
	HULOB_COMBAT_JUICE.play_hit_pause(self, 0.09, 0.22)
	_play_player_attack_animation(&"side")
...
func _apply_attack_hits() -> void:
	...
	for target in targets:
		...
		HULOB_COMBAT_JUICE.play_hit_pause(self)
		HULOB_COMBAT_JUICE.spawn_hit_flash(self, hit_position, facing_direction)
...
func _setup_player_light() -> void:
	...
	var hulob_atmosphere := scene.get_node_or_null("Atmosphere/HulobCanvasModulate") if scene != null else null
	if scene != null and hulob_atmosphere == null and scene.get_node_or_null("SceneDarkness") == null:
