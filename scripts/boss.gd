...
const DASH_FRAME_PATHS: Array[String] = [
	"res://hulobOuO/assets/boss/octopus_actions/dash_1.png",
	"res://hulobOuO/assets/boss/octopus_actions/dash_2.png",
	"res://hulobOuO/assets/boss/octopus_actions/dash_3.png",
	"res://hulobOuO/assets/boss/octopus_actions/dash_4.png",
]

const JUMP_FRAME_PATHS: Array[String] = [
	"res://hulobOuO/assets/boss/octopus_actions/jump_1.png",
	"res://hulobOuO/assets/boss/octopus_actions/jump_2.png",
	"res://hulobOuO/assets/boss/octopus_actions/jump_3.png",
	"res://hulobOuO/assets/boss/octopus_actions/jump_4.png",
	"res://hulobOuO/assets/boss/octopus_actions/jump_5.png",
]

const THROW_FRAME_PATHS: Array[String] = [
	"res://hulobOuO/assets/boss/octopus_actions/throw_1.png",
	"res://hulobOuO/assets/boss/octopus_actions/throw_2.png",
	"res://hulobOuO/assets/boss/octopus_actions/throw_3.png",
	"res://hulobOuO/assets/boss/octopus_actions/throw_4.png",
]
...
func take_damage(amount: int, from_position: Vector2 = Vector2.ZERO) -> void:
	...
	HULOB_COMBAT_JUICE.play_hit_pause(self, 0.055, 0.08)
...
func _begin_death_sequence() -> void:
	...
	HULOB_COMBAT_JUICE.shake_camera(self, 1.15, 18.0)
	_play_hulob_defeat_sfx()
...
func _play_hulob_defeat_sfx() -> void:
	if not HULOB_COMBAT_JUICE.is_enabled(self):
		return

	var stream := load("res://hulobOuO/assets/hollow_import/audio/boss_explode.wav")
	if stream == null:
		return

	var sfx := AudioStreamPlayer2D.new()
	sfx.name = "HulobBossDefeatSfx"
	sfx.stream = stream
	sfx.volume_db = -2.0
...
func _begin_anti_pogo_counter() -> void:
	...
	velocity = Vector2.ZERO
	HULOB_COMBAT_JUICE.shake_camera(self, 0.16, 6.0)
...
func _launch_anti_pogo_counter() -> void:
	...
	HULOB_COMBAT_JUICE.shake_camera(self, 0.22, 8.5)
	velocity.x = 0.0
...
func _play_dash_end_impact() -> void:
	HULOB_COMBAT_JUICE.shake_camera(self, 0.16, dash_end_impact_shake)
