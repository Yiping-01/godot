...
const ITEM_TEXTURE := preload("res://hulobOuO/assets/hollow_import/effects/glow_bug_01.png")
const NOTE_TEXTURE := preload("res://assets/useicon_white.png")
const SKILL_TEXTURE := preload("res://assets/player/attack_far/far_1.png")
const MAP_DRAW_CANVAS_SCRIPT := preload("res://scripts/map_draw_canvas.gd")
...
const HULOB_UI_FONT_PATH := "res://hulobOuO/assets/hollow_import/fonts/NotoSerifCJKsc-Regular.otf"
const HULOB_TITLE_FONT_PATH := "res://hulobOuO/assets/hollow_import/fonts/TrajanPro-Regular.otf"
const SKILL_LIBRARY := [
	{
		"id": "water_dash",
	...
	},
	{
		...
		"texture": "res://assets/player/attack_far/far_5.png",
		"cooldown": "6 秒",
	},
	{
		"id": "flash_burst",
		...
		"texture": "res://hulobOuO/assets/hollow_import/effects/flash_round.png",
		"cooldown": "3 秒",
	},
]
...
func _configure_hulob_coin_hud() -> void:
	if hud_currency_label == null or not _is_hulob_scene():
		return
...
func _is_hulob_scene() -> bool:
	var scene := get_tree().current_scene
	return scene != null and scene.scene_file_path.begins_with("res://hulobOuO/")
...
func _t(key: String) -> String:
	var override := _hulob_text_override(key)
	if override != "":
		return override
	var localization: Node = _get_localization()
...
func _hulob_text_override(key: String) -> String:
	var localization: Node = _get_localization()
...
func _apply_hulob_ui_fonts() -> void:
	var body_font := load(HULOB_UI_FONT_PATH)
...
func _inventory_texture_for_item(item_name: String) -> String:
	if GameState.is_health_potion_item(item_name):
		return "res://assets/some/Health_Potion.png"
	if item_name == GameState.STARTER_ITEM:
		return "res://assets/useicon_white.png"
	return "res://hulobOuO/assets/hollow_import/effects/glow_bug_01.png"
