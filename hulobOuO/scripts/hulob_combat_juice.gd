extends Node
class_name HulobCombatJuice

const HULOB_SCENE_PREFIX := "res://hulobOuO/"
const FLASH_TEXTURE_PATH := "res://hulobOuO/assets/hollow_import/effects/flash_round.png"
const BURST_TEXTURE_PATH := "res://hulobOuO/assets/hollow_import/effects/explode_particle.png"
const SMOKE_TEXTURE_PATH := "res://hulobOuO/assets/hollow_import/effects/orange_puff_animated.png"
const SPARK_TEXTURE_PATH := "res://hulobOuO/assets/hollow_import/effects/white_hit_particle.png"
const DONUT_TEXTURE_PATH := "res://hulobOuO/assets/hollow_import/effects/white_light_donut.png"
...
static func is_enabled(context: Node) -> bool:
	...
	return scene != null and scene.scene_file_path.begins_with(HULOB_SCENE_PREFIX)
...
static func _spawn_particle_burst(root: Node, position: Vector2, texture: Texture2D, amount: int, lifetime: float, velocity: float, color: Color) -> void:
	...
	particles.name = "HulobBurstParticles"
...
static func _spawn_boss_flash(root: Node, position: Vector2, scale_multiplier: float) -> void:
	...
	if flash_texture == null:
		return
	var flash := Sprite2D.new()
	flash.name = "HulobBossDeathFlash"
	flash.texture = flash_texture
