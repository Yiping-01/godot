...
const LEVEL1_SCENE := "res://hulobOuO/hulob_level1.tscn"
const TITLE_FONT_PATH := "res://hulobOuO/assets/hollow_import/fonts/TrajanPro-Regular.otf"
const BODY_FONT_PATH := "res://hulobOuO/assets/hollow_import/fonts/NotoSerifCJKsc-Regular.otf"
const TITLE_MUSIC_PATH := "res://scores/bgtitle_music.wav"
const UI_CONFIRM_PATH := "res://scores/jump.wav"
...
func _text(key: String, en: String, zh: String) -> String:
	var localization := _get_localization()
	if localization != null and String(localization.get("current_locale")) != "en" and key.begins_with("HULOB_"):
		return zh
