...
const GLOW_TEXTURE_PATH := "res://hulobOuO/assets/hollow_import/effects/flash_round.png"
const WATER_TEXTURE_PATH := "res://hulobOuO/assets/hollow_import/effects/water_footstep_particle.png"
const FAR_BG_TEXTURE_PATH := "res://hulobOuO/BACKGROUND/parallax_bg_far.png"
const MID_BG_TEXTURE_PATH := "res://hulobOuO/BACKGROUND/parallax_bg_mid.png"
const NEAR_BG_TEXTURE_PATH := "res://hulobOuO/BACKGROUND/parallax_bg_near.png"
const FLOOR_TEXTURE_PATH := "res://hulobOuO/BACKGROUND/base_floor_single.png"
const PAINTED_FLOOR_TEXTURE_PATHS := [
	"res://hulobOuO/assets/tiles/floor_stone_tile_01.png",
	"res://hulobOuO/assets/tiles/floor_stone_tile_02.png",
	"res://hulobOuO/assets/tiles/floor_stone_tile_03.png",
	"res://hulobOuO/assets/tiles/floor_stone_tile_04.png",
]
const WALL_TEXTURE_PATH := "res://hulobOuO/BACKGROUND/base_wall_single.png"
const CEILING_TEXTURE_PATH := "res://hulobOuO/BACKGROUND/base_ceiling_single.png"
const PLANT_TEXTURE_PATH := "res://hulobOuO/BACKGROUND/deepsea_prop_plant.png"
...
func _build_canvas_modulate() -> void:
	var existing := get_node_or_null("HulobCanvasModulate") as CanvasModulate
	if existing != null:
		existing.color = environment_tint
		return

	var modulate_node := CanvasModulate.new()
	modulate_node.name = "HulobCanvasModulate"
...
func _remove_scene_backdrops() -> void:
	...
	for child in get_children():
		if child.name.begins_with("HulobFog") or child.name.begins_with("HulobAirMotes"):
			child.queue_free()


func _build_environment_layers() -> void:
	var root := get_node_or_null("HulobEnvironment")
	if root != null:
		root.queue_free()

	root = Node2D.new()
	root.name = "HulobEnvironment"
	root.z_index = -480
	add_child(root)
...
func _add_water_glimmer(parent: Node) -> void:
	...
	for index in range(5):
		...
		water.name = "HulobWaterGlimmer%d" % index
...
func _attach_player_glow() -> void:
	...
	player_glow = (player as Node2D).get_node_or_null("HulobPlayerGlow") as PointLight2D
	if player_glow == null:
		player_glow = PointLight2D.new()
		player_glow.name = "HulobPlayerGlow"
