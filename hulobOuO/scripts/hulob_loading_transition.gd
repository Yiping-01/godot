extends CanvasLayer
class_name HulobLoadingTransition

const WALK_FRAMES := [
	"res://assets/player/Walk/sea0_walk_1.png",
	"res://assets/player/Walk/sea0_walk_2.png",
	"res://assets/player/Walk/sea0_walk_3.png",
	"res://assets/player/Walk/sea0_walk_4.png",
	"res://assets/player/Walk/sea0_walk_5.png",
]
