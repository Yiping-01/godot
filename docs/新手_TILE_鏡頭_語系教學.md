...
- Godot i18n 翻譯檔：`res://i18n/en.po`、`res://i18n/zh.po`
- 主要海洋岩石 Tile 圖：`res://hulobOuO/assets/tiles/ocean_rock_modular_tiles.png`
- 主要海洋岩石 TileSet：`res://hulobOuO/assets/tiles/ocean_rock_modular_tileset.tres`
- 舊版簡單草稿 Tile 圖：`res://hulobOuO/assets/tiles/hulob_floor_tilesheet.png`
- 舊版簡單草稿 TileSet：`res://hulobOuO/assets/tiles/hulob_floor_tileset.tres`
- 給你畫地圖用的空白空間：`res://hulobOuO/tile_paint_workspace.tscn`
...
3. 在左下 FileSystem 找到：
   `hulobOuO/tile_paint_workspace.tscn`
4. 雙擊打開。
...
`res://hulobOuO/assets/tiles/ocean_rock_modular_tiles.png`
...
1. 用 Aseprite 打開：
   `hulobOuO/assets/tiles/hulob_floor_tilesheet.png`
2. 設定 Grid：
   - Width：32
   - Height：32
3. 開啟 Tilemap layer。
